...
Caculate(int gridamount,string pricetype)
{
    ...
    cout<<minprice<<" "<<maxprice<<" "<<timegothrough<<" ";
    cout<<"gridamount= "<<gridamount<<" space= "<<aprofit<<"% IRR= "<<(float)aprofitinall*sale*365.0/timegothrough<<"%\n";
}
...
int main()
{
    ...
    type=type+"_bars.csv";
    for(int i=5;i<150;i++)Caculate(i,type);
